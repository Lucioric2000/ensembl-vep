...
SKIP: {
  ...
  # use test
  #use_ok('Bio::EnsEMBL::VEP::Haplo::AnnotationSource::File::GFF');
  ...
  ok(
    my $as = Bio::EnsEMBL::VEP::Haplo::AnnotationSource::File::GFF->new({
      file => $test_cfg->{custom_gff},
      config => $runner->config
    }),
    'new is defined'
  );
  is(ref($as), 'Bio::EnsEMBL::VEP::Haplo::AnnotationSource::File::GFF', 'new ref');
